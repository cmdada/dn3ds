...
#include "sounds.h"
#ifdef __3DS__
extern int n3ds_build_args(int argc, char **argv, char ***out_argv);
#endif
#include "config.h"
#include "sndcards.h"
...
void displayrooms(short snum,int32_t smoothratio)
{
    ...
    else
    {
        ...
        drawmasks();
#ifdef __3DS__
        n3ds_stereo_render_right(cposx,cposy,cposz,cang,choriz,sect,smoothratio);
#endif
...
int main(int argc,char  **argv)
{
	...
	{
		char **n3ds_argv;
		int    n3ds_argc = n3ds_build_args(argc, argv, &n3ds_argv);
		checkcommandline(n3ds_argc, n3ds_argv);
	}
#else
